...
class Sketch {
  constructor(opts) {
    ...
    this.clicker = opts.clicker || document.body;
    this.prevClicker = opts.prevClicker || document.body;

    // console.log( 'THREE.WebGLRenderer', REVISION );

    console.log(opts.slider)

    this.container = opts.slider || document.getElementById("slider");
    this.images = opts.images || JSON.parse(this.container.getAttribute('data-images'));
  ...
  clickEvent(){
    ...
    this.nextExtern = this.next;
    this.prevExtern = this.prev;
  ...
  addObjects() {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        displacement: { type: "f", value: new THREE.TextureLoader().load('/dist/assets/images/disp1.jpg') },
