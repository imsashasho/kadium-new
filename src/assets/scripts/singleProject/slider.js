...
// 	});
	...
	slider[0].on('slideNextTransitionStart', (obj) => {
	  msGlSlider.nextExtern()
	})
	slider[0].on('slidePrevTransitionStart', () => {
...
//   document.addEventListener('DOMContentLoaded', init);
  ...
  function mainScreenGlSlider() {
	...
	const imagesForGl = Array.from(document.querySelectorAll('.single-project-slider .swiper-slide:not(.swiper-slide-duplicate) .swiper-slide img')).map(img => img.src);
