...
export class Slideshow extends EventEmitter {
  constructor(el) {
    ...
    this.config = {
      clipPath: {
        // initial: 'polygon(50% 0%, 100% 0, 100% 100%, 50% 100%, 20% 50%)',
        initial: 'polygon(100% 0%,100% 50%,100% 100%,50% 100%,30% 50%,50% 0%)',
        final: 'polygon(78% 10%,60% 50%,79% 89%,50% 90%,30% 50%,47% 10%)',
        hover: 'polygon(70% 26%,55% 61%,74% 93%,45% 94%,19% 65%,44% 26%)',
      },
    };
    this.init();
  }
